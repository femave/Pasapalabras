...
function questionsx(){
   var questionsa = [
     { letter: "a", answer: "atmosfera", status: 0, question: ("CON LA A. Capa gaseosa que envuelve a la atmósfera") },
     { letter: "a", answer: "artropodos", status: 0, question: ("CON LA A. Grupo de invertebrados con las patas articuladas") },
     { letter: "a", answer: "abducir", status: 0, question: ("CON LA A. Dicho de una supuesta criatura extraterrestre: Apoderarse de alguien") },
     { letter: "a", answer: "autotrofo", status: 0, question: ("CON LA A. Tipo de nutrición en la que el ser vivo fabrica sus propios nutrientes") }
    ]
   ...
   var questionsc = [
    ...
    var questionsd = [
      ...
      { letter: "d", answer: "dado", status: 0, question: ("CON LA D. Cubo de 6 caras para jugar a juegos de mesa") }
    ]
    ...
    var questionsg = [
      ...
      { letter: "g", answer: "geocentrica", status: 0, question: ("CON LA G. Nombre de la teoría, defendida entre otros por Ptolomeo, que decía que la Tierra era el centro del Universo") },
    ...
    var questionsj = [
      ...
      { letter: "j", answer: "jorobado", status: 0, question: ("CON LA J. El ______ de Notredam") },
    ]
    ...
    var questionsñ = [
      ...
      { letter: "ñ", answer: "daño", status: 0, question: ("CONTIENE LA Ñ. Cuando suffres algun tipo de golpe o herida te produce?") },
      { letter: "ñ", answer: "ñu", status: 0, question: ("CON LA Ñ. Animal que habita en africa sobretodo") }
    ]
    ...
    var questionsq = [
      ...
      { letter: "q", answer: "parque", status: 0, question: ("CONTIENE LA Q. Lugar donde van a jugar los niños") }
    ]
    ...
    var questionsy = [
      ...
      { letter: "y", answer: "yunque", status: 0, question: ("CON LA Y. Herramienta usada por los herreros") },
      { letter: "y", answer: "yegua", status: 0, question: ("CON LA Y. La mujer del caballo") }
    ]
    ...
    questions.push(questionsa[Math.floor((Math.random() * questionsa.length))])
    questions.push(questionsb[Math.floor((Math.random() * questionsb.length))])
    questions.push(questionsc[Math.floor((Math.random() * questionsc.length))])
    questions.push(questionsd[Math.floor((Math.random() * questionsd.length))])
    questions.push(questionse[Math.floor((Math.random() * questionse.length))])
    questions.push(questionsf[Math.floor((Math.random() * questionsf.length))])
    questions.push(questionsg[Math.floor((Math.random() * questionsg.length))])
    questions.push(questionsh[Math.floor((Math.random() * questionsh.length))])
    questions.push(questionsi[Math.floor((Math.random() * questionsi.length))])
    questions.push(questionsj[Math.floor((Math.random() * questionsj.length))])
    questions.push(questionsl[Math.floor((Math.random() * questionsl.length))])
    questions.push(questionsm[Math.floor((Math.random() * questionsm.length))])
    questions.push(questionsn[Math.floor((Math.random() * questionsn.length))])
    questions.push(questionsñ[Math.floor((Math.random() * questionsñ.length))])
    questions.push(questionso[Math.floor((Math.random() * questionso.length))])
    questions.push(questionsp[Math.floor((Math.random() * questionsp.length))])
    questions.push(questionsq[Math.floor((Math.random() * questionsq.length))])
    questions.push(questionsr[Math.floor((Math.random() * questionsr.length))])
    questions.push(questionss[Math.floor((Math.random() * questionss.length))])
    questions.push(questionst[Math.floor((Math.random() * questionst.length))])
    questions.push(questionsu[Math.floor((Math.random() * questionsu.length))])
    questions.push(questionsv[Math.floor((Math.random() * questionsv.length))])
    questions.push(questionsx[Math.floor((Math.random() * questionsx.length))])
    questions.push(questionsy[Math.floor((Math.random() * questionsy.length))])
    questions.push(questionsz[Math.floor((Math.random() * questionsz.length))])
...
function playAgain(){
  ...
  document.getElementById("timer2").textContent = timeleft;
  document.getElementById("question1").textContent = "Welcome to pasapalabras";
  ...
  for(var i = 0; i < 25; i++){
    var x = document.getElementById("letter");
    x.getElementsByTagName("span")[i].style.background = "#0011DE";
    x.getElementsByTagName("div")[i].classList.add("hidden");
    x.getElementsByTagName("div")[i].classList.remove("solution");
    x.getElementsByTagName("div")[i].textContent = "";
    questions.splice(0,25)
    console.log(i)
  }
/*  if(startagain !== 0){
    startagain --
    ...
    x.getElementsByTagName("div")[startagain].textContent = "";
